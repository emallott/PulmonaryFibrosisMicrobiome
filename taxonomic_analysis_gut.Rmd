...
We also wanted to look at the effect of sex within floors. PERMANOVAs were carried out both for all samples on a given floor, and for each treatment separately.
...
ggarrange(div_plot_absl1, even_plot_absl1, rich_plot_absl1, 
